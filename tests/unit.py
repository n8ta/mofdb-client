...
class BasicTests(unittest.TestCase):
    ...
    def test_mof_fields(self):
        ...
        mofs = list(fetch())
        mof = mofs[0]
        self.assertEqual(mof.mofid,
                         "[Eu].[O-]C(=O)C(=O)[O-].[O-]C(=O)C1=C([N]C=N1)C(=O)[O-].[O-]C(=O)C1=NC=N[C]1C(=O)[O-].[O-]C(=O)C1=N[C]N=C1C(=O)[O-].[Zn] MOFid-v1.ERROR.cat0")
